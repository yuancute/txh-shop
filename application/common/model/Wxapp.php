...
class Wxapp extends BaseModel
{
    ...
    {
        return $this->belongsTo('uploadFile','service_image_id','wxapp_id');
    }
    //电话客服图标
    public function phoneImage()
    {
        return $this->belongsTo('uploadFile','phone_image_id','wxapp_id');
    }
    ...
    public static function detail($wxapp_id = null)
    {
        ...
        return self::get($wxapp_id,['serviceImage', 'phoneImage']);
    }
    ...
    public static function getWxappCache($wxapp_id = null)
    {
        ...
        if(!$data = Cache::get('wxapp_'.$wxapp_id)){
            ...
            if(empty($data)){
                throw new BaseException(['msg'=>'未找到当前小程序']);
            }
